...
- `backend/app/config.py` — `opencode_binary`, `extraction_model`, `extraction_prompt_version`, `extraction_timeout_seconds` (seit Backoffice-Fix 2026-07-29: 60s, pydantic-settings).
