...
- Backtests erhalten vollständigen Pine-Script-v5/v6-Quellcode über `run_backtest`; aktuelle Codegenerierung zielt auf v6. Ergebnisse werden über `get_backtest_result` abgefragt.
